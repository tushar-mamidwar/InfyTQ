...
def reverse_linkedlist(reverse_list):
    previous_tail = None
    temp = reverse_list.get_tail()
    initial_head = reverse_list.get_head().get_data()
    reverse_list.delete(temp.get_data())
    reverse_list.insert(temp.get_data(), None)
    while temp.get_data() != initial_head:
        previous_tail = temp
        temp = reverse_list.get_tail()
        reverse_list.delete(temp.get_data())
        reverse_list.insert(temp.get_data(), previous_tail.get_data())
    return reverse_list
