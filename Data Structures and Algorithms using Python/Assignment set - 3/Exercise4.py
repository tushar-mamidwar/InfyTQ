...
Here, people_queue represents a queue of people. Each person is identified by their name, 
age and gender. This method should create and return a new queue with the people belonging 
